...
export type GetCustomerCountQuery = (
  { __typename?: 'Query' }
  & { customers: (
    { __typename?: 'CustomerList' }
...
export type UpdateChannelMutation = (
  ...
  & { updateChannel: (
    { __typename?: 'Channel' }
    & Pick<Channel, 'id' | 'code' | 'defaultLanguageCode' | 'currencyCode'>
  ) }
);
...
export type UpdateGlobalSettingsMutation = (
  ...
  & { updateGlobalSettings: (
    { __typename?: 'GlobalSettings' }
    & Pick<GlobalSettings, 'id' | 'availableLanguages'>
  ) }
);
...
export type GetCollectionBreadcrumbsQuery = (
  ...
  & { collection?: Maybe<(
    ...
    & { breadcrumbs: Array<(
      { __typename?: 'CollectionBreadcrumb' }
      & Pick<CollectionBreadcrumb, 'id' | 'name'>
    )> }
  )> }
);
...
export type SearchProductsAdminQuery = (
  ...
  & { search: (
    ...
    & { items: Array<(
      { __typename?: 'SearchResult' }
      & Pick<SearchResult, 'enabled' | 'productId' | 'productName' | 'productPreview' | 'productVariantId' | 'productVariantName' | 'productVariantPreview' | 'sku'>
    )> }
  ) }
);
...
export type AssetFragment = (
  { __typename?: 'Asset' }
  & Pick<Asset, 'id' | 'name' | 'fileSize' | 'mimeType' | 'type' | 'preview' | 'source'>
);
...
export type ProductVariantFragment = (
  ...
  & { taxRateApplied: (
    ...
    { __typename?: 'ProductOption' }
    & Pick<ProductOption, 'id' | 'code' | 'languageCode' | 'name'>
  )>, facetValues: Array<(
    { __typename?: 'FacetValue' }
...
export type ProductWithVariantsFragment = (
  ...
  & { featuredAsset?: Maybe<(
    ...
    { __typename?: 'ProductTranslation' }
    & Pick<ProductTranslation, 'languageCode' | 'name' | 'slug' | 'description'>
  )>, optionGroups: Array<(
    { __typename?: 'ProductOptionGroup' }
...
export type CollectionFragment = (
  { __typename?: 'Collection' }
  & Pick<Collection, 'id' | 'name' | 'description' | 'isPrivate' | 'languageCode'>
  & { featuredAsset?: Maybe<(
    { __typename?: 'Asset' }
    & AssetFragment
  )>, assets: Array<(
...
export type CurrentUserFragment = (
  ...
  & { channels: Array<(
    { __typename?: 'CurrentUserChannel' }
    & Pick<CurrentUserChannel, 'code' | 'token' | 'permissions'>
  )> }
);
...
export type GetRunningJobsQuery = (
  ...
  & { jobs: (
    ...
    & { items: Array<(
      { __typename?: 'Job' }
      & Pick<Job, 'id' | 'queueName' | 'state' | 'isSettled' | 'duration'>
    )> }
  ) }
);
...
export type UpdateOptionGroupMutation = (
  { __typename?: 'Mutation' }
  & { updateProductOptionGroup: (
    { __typename?: 'ProductOptionGroup' }
    & Pick<ProductOptionGroup, 'id'>
  ) }
);
...
export type DeletePromotionAdHoc1Mutation = (
  { __typename?: 'Mutation' }
  & { deletePromotion: (
    { __typename?: 'DeletionResponse' }
    & Pick<DeletionResponse, 'result'>
...
export type SettlePaymentMutation = (
  ...
  & { settlePayment: (
    { __typename?: 'Payment' }
    & Pick<Payment, 'id' | 'state' | 'metadata'>
  ) }
);
...
export type CreateFulfillmentMutation = (
  ...
  & { fulfillOrder: (
    { __typename?: 'Fulfillment' }
    & Pick<Fulfillment, 'id' | 'method' | 'trackingCode'>
    & { orderItems: Array<(
      { __typename?: 'OrderItem' }
      & Pick<OrderItem, 'id'>
    )> }
...
export type RefundOrderMutation = (
  ...
  & { refundOrder: (
    { __typename?: 'Refund' }
    & Pick<Refund, 'id' | 'state' | 'items' | 'transactionId' | 'shipping' | 'total' | 'metadata'>
  ) }
);
...
export type GetEligibilityCheckersQuery = (
  ...
  & { shippingEligibilityCheckers: Array<(
    ...
    & { args: Array<(
      { __typename?: 'ConfigArgDefinition' }
      & Pick<ConfigArgDefinition, 'name' | 'type' | 'description' | 'label' | 'config'>
    )> }
  )> }
);
...
export type GetProductsTake3Query = (
  { __typename?: 'Query' }
  & { products: (
    { __typename?: 'ProductList' }
    & { items: Array<(
...
export type GetCustomerIdsQuery = (
  { __typename?: 'Query' }
  & { customers: (
    { __typename?: 'CustomerList' }
    & { items: Array<(
...
export namespace GetCollectionsWithAssets {
  ...
  export type Assets = (NonNullable<(NonNullable<GetCollectionsWithAssetsQuery['collections']['items'][0]>)['assets'][0]>);
}
...
export namespace GetProductsWithVariantIds {
  ...
  export type Variants = (NonNullable<(NonNullable<GetProductsWithVariantIdsQuery['products']['items'][0]>)['variants'][0]>);
}
...
export namespace GetCollection {
  ...
  export type Items = (NonNullable<(NonNullable<GetCollectionQuery['collection']>)['productVariants']['items'][0]>);
}
...
export namespace GetCollectionProducts {
  ...
  export type Items = (NonNullable<(NonNullable<GetCollectionProductsQuery['collection']>)['productVariants']['items'][0]>);
  export type FacetValues = (NonNullable<(NonNullable<(NonNullable<GetCollectionProductsQuery['collection']>)['productVariants']['items'][0]>)['facetValues'][0]>);
}
...
export namespace CreateCollectionSelectVariants {
  ...
  export type Items = (NonNullable<CreateCollectionSelectVariantsMutation['createCollection']['productVariants']['items'][0]>);
}
...
export namespace GetCollectionBreadcrumbs {
  ...
  export type Breadcrumbs = (NonNullable<(NonNullable<GetCollectionBreadcrumbsQuery['collection']>)['breadcrumbs'][0]>);
}
...
export namespace GetCollectionsForProducts {
  ...
  export type Collections = (NonNullable<(NonNullable<GetCollectionsForProductsQuery['products']['items'][0]>)['collections'][0]>);
}
...
export namespace GetProductCollections {
  ...
  export type Collections = (NonNullable<(NonNullable<GetProductCollectionsQuery['product']>)['collections'][0]>);
}
...
export namespace SearchGetAssets {
  ...
  export type ProductAsset = (NonNullable<(NonNullable<SearchGetAssetsQuery['search']['items'][0]>)['productAsset']>);
  export type FocalPoint = (NonNullable<(NonNullable<(NonNullable<SearchGetAssetsQuery['search']['items'][0]>)['productAsset']>)['focalPoint']>);
  export type ProductVariantAsset = (NonNullable<(NonNullable<SearchGetAssetsQuery['search']['items'][0]>)['productVariantAsset']>);
  export type _FocalPoint = (NonNullable<(NonNullable<(NonNullable<SearchGetAssetsQuery['search']['items'][0]>)['productVariantAsset']>)['focalPoint']>);
}
...
export namespace SearchGetPrices {
  ...
  export type PriceRangeInlineFragment = (DiscriminateUnion<RequireField<(NonNullable<SearchGetPricesQuery['search']['items'][0]>)['price'], '__typename'>, { __typename: 'PriceRange' }>);
  export type SinglePriceInlineFragment = (DiscriminateUnion<RequireField<(NonNullable<SearchGetPricesQuery['search']['items'][0]>)['price'], '__typename'>, { __typename: 'SinglePrice' }>);
  export type PriceWithTax = (NonNullable<SearchGetPricesQuery['search']['items'][0]>)['priceWithTax'];
  export type _PriceRangeInlineFragment = (DiscriminateUnion<RequireField<(NonNullable<SearchGetPricesQuery['search']['items'][0]>)['priceWithTax'], '__typename'>, { __typename: 'PriceRange' }>);
  export type _SinglePriceInlineFragment = (DiscriminateUnion<RequireField<(NonNullable<SearchGetPricesQuery['search']['items'][0]>)['priceWithTax'], '__typename'>, { __typename: 'SinglePrice' }>);
}
...
export namespace IdTest2 {
  ...
  export type Options = (NonNullable<(NonNullable<(NonNullable<IdTest2Query['products']['items'][0]>)['variants'][0]>)['options'][0]>);
}
...
export namespace GetProductListWithVariants {
  ...
  export type Variants = (NonNullable<(NonNullable<GetProductListWithVariantsQuery['products']['items'][0]>)['variants'][0]>);
}
...
export namespace VariantWithStock {
  ...
  export type StockMovementInlineFragment = (DiscriminateUnion<RequireField<(NonNullable<VariantWithStockFragment['stockMovements']['items'][0]>), '__typename'>, { __typename: 'StockMovement' }>);
}
...
export namespace CreateChannel {
  ...
  export type DefaultShippingZone = (NonNullable<CreateChannelMutation['createChannel']['defaultShippingZone']>);
...
export namespace GetPromoProducts {
  ...
  export type Variants = (NonNullable<(NonNullable<GetPromoProductsQuery['products']['items'][0]>)['variants'][0]>);
  export type FacetValues = (NonNullable<(NonNullable<(NonNullable<GetPromoProductsQuery['products']['items'][0]>)['variants'][0]>)['facetValues'][0]>);
}
...
export namespace GetOrderFulfillments {
  ...
  export type Fulfillments = (NonNullable<(NonNullable<(NonNullable<GetOrderFulfillmentsQuery['order']>)['fulfillments']>)[0]>);
}
...
export namespace GetOrderListFulfillments {
  ...
  export type Fulfillments = (NonNullable<(NonNullable<(NonNullable<GetOrderListFulfillmentsQuery['orders']['items'][0]>)['fulfillments']>)[0]>);
}
...
export namespace GetOrderFulfillmentItems {
  ...
  export type Fulfillments = (NonNullable<(NonNullable<(NonNullable<GetOrderFulfillmentItemsQuery['order']>)['fulfillments']>)[0]>);
  export type OrderItems = (NonNullable<(NonNullable<(NonNullable<(NonNullable<GetOrderFulfillmentItemsQuery['order']>)['fulfillments']>)[0]>)['orderItems'][0]>);
}
...
export namespace CreateProductOption {
  ...
  export type Translations = (NonNullable<CreateProductOptionMutation['createProductOption']['translations'][0]>);
}
...
export namespace GetEligibilityCheckers {
  ...
  export type ShippingEligibilityCheckers = (NonNullable<GetEligibilityCheckersQuery['shippingEligibilityCheckers'][0]>);
  export type Args = (NonNullable<(NonNullable<GetEligibilityCheckersQuery['shippingEligibilityCheckers'][0]>)['args'][0]>);
}
...
export namespace TestEligibleMethods {
  ...
  export type TestEligibleShippingMethods = (NonNullable<TestEligibleMethodsQuery['testEligibleShippingMethods'][0]>);
}
...
export namespace GetProductCollection {
  ...
  export type Collections = (NonNullable<(NonNullable<GetProductCollectionQuery['product']>)['collections'][0]>);
}
...
export namespace GetCollectionVariants {
  ...
  export type Items = (NonNullable<(NonNullable<GetCollectionVariantsQuery['collection']>)['productVariants']['items'][0]>);
}
...
export namespace GetProductFacetValues {
  ...
  export type FacetValues = (NonNullable<(NonNullable<GetProductFacetValuesQuery['product']>)['facetValues'][0]>);
}
...
export namespace GetVariantFacetValues {
  ...
  export type FacetValues = (NonNullable<(NonNullable<(NonNullable<GetVariantFacetValuesQuery['product']>)['variants'][0]>)['facetValues'][0]>);
}
