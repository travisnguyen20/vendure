...
export type RegisterMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'registerCustomerAccount'>
);
...
export type RefreshTokenMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'refreshCustomerVerification'>
);
...
export type RequestUpdateEmailAddressMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'requestUpdateCustomerEmailAddress'>
);
...
export type UpdateEmailAddressMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'updateCustomerEmailAddress'>
);
...
export type DeleteAddressShopMutation = (
  { __typename?: 'Mutation' }
...
export type UpdatePasswordMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'updateCustomerPassword'>
);
...
export type GetShippingMethodsQuery = (
  ...
  & { eligibleShippingMethods: Array<(
    { __typename?: 'ShippingMethodQuote' }
    & Pick<ShippingMethodQuote, 'id' | 'price' | 'description'>
  )> }
);
...
export type AddPaymentToOrderMutation = (
  ...
  & { addPaymentToOrder?: Maybe<(
    ...
    & { payments?: Maybe<Array<(
      { __typename?: 'Payment' }
      & Pick<Payment, 'id' | 'transactionId' | 'method' | 'amount' | 'state' | 'metadata'>
    )>> }
    & TestOrderFragmentFragment
  )> }
);
...
export type GetActiveOrderPaymentsQuery = (
  ...
  & { activeOrder?: Maybe<(
    ...
    & { payments?: Maybe<Array<(
      { __typename?: 'Payment' }
      & Pick<Payment, 'id' | 'transactionId' | 'method' | 'amount' | 'state' | 'errorMessage' | 'metadata'>
    )>> }
  )> }
);
...
export namespace AddItemToOrder {
  ...
  export type ProductVariant = (NonNullable<(NonNullable<AddItemToOrderMutation['addItemToOrder']>)['lines'][0]>)['productVariant'];
  export type Adjustments = (NonNullable<(NonNullable<AddItemToOrderMutation['addItemToOrder']>)['adjustments'][0]>);
}
...
export namespace SetShippingMethod {
  ...
  export type ShippingMethod = (NonNullable<(NonNullable<SetShippingMethodMutation['setOrderShippingMethod']>)['shippingMethod']>);
}
...
export namespace SetCustomerForOrder {
  ...
  export type Customer = (NonNullable<(NonNullable<SetCustomerForOrderMutation['setCustomerForOrder']>)['customer']>);
}
...
export namespace GetOrderPromotionsByCode {
  ...
  export type OrderByCode = TestOrderFragmentFragment;
  export type Promotions = (NonNullable<(NonNullable<GetOrderPromotionsByCodeQuery['orderByCode']>)['promotions'][0]>);
}
...
export namespace AddPaymentToOrder {
  ...
  export type Payments = (NonNullable<(NonNullable<(NonNullable<AddPaymentToOrderMutation['addPaymentToOrder']>)['payments']>)[0]>);
}
...
export namespace GetActiveOrderPayments {
  ...
  export type Payments = (NonNullable<(NonNullable<(NonNullable<GetActiveOrderPaymentsQuery['activeOrder']>)['payments']>)[0]>);
}
...
export namespace GetCustomerAddresses {
  ...
  export type Addresses = (NonNullable<(NonNullable<(NonNullable<(NonNullable<GetCustomerAddressesQuery['activeOrder']>)['customer']>)['addresses']>)[0]>);
}
...
export namespace GetCustomerOrders {
  ...
  export type Orders = (NonNullable<(NonNullable<GetCustomerOrdersQuery['activeOrder']>)['customer']>)['orders'];
  export type Items = (NonNullable<(NonNullable<(NonNullable<GetCustomerOrdersQuery['activeOrder']>)['customer']>)['orders']['items'][0]>);
}
