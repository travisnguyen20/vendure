...
export namespace SearchProductsAdmin {
  ...
  export type ProductAsset = (NonNullable<(NonNullable<SearchProductsAdminQuery['search']['items'][0]>)['productAsset']>);
  export type FocalPoint = (NonNullable<(NonNullable<(NonNullable<SearchProductsAdminQuery['search']['items'][0]>)['productAsset']>)['focalPoint']>);
  export type ProductVariantAsset = (NonNullable<(NonNullable<SearchProductsAdminQuery['search']['items'][0]>)['productVariantAsset']>);
  export type _FocalPoint = (NonNullable<(NonNullable<(NonNullable<SearchProductsAdminQuery['search']['items'][0]>)['productVariantAsset']>)['focalPoint']>);
}
