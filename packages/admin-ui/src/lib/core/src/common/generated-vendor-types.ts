...
export type VendorFragment = (
  { __typename?: 'Vendor' }
  & Pick<Vendor, 'id' | 'createdAt' | 'updatedAt' | 'firstName' | 'lastName' | 'emailAddress'>
  & { user: (
    { __typename?: 'User' }
...
export type AssignRoleToVendorMutationVariables = {
  vendorId: Scalars['ID'];
  roleId: Scalars['ID'];
};


export type AssignRoleToVendorMutation = (
  { __typename?: 'Mutation' }
  & { assignRoleToVendor: (
    { __typename?: 'Vendor' }
    & VendorFragment
...
export namespace Vendor {
  export type Fragment = VendorFragment;
  export type User = VendorFragment['user'];
  export type Roles = RoleFragment;
}

export namespace GetVendors {
  export type Variables = GetVendorsQueryVariables;
  export type Query = GetVendorsQuery;
  export type Vendors = GetVendorsQuery['vendors'];
  export type Items = VendorFragment;
}

export namespace GetVendor {
  export type Variables = GetVendorQueryVariables;
  export type Query = GetVendorQuery;
  export type Vendor = VendorFragment;
}
...
export namespace CreateVendor {
  ...
  export type CreateVendor = VendorFragment;
}
...
export namespace UpdateVendor {
  ...
  export type UpdateVendor = VendorFragment;
}

export namespace AssignRoleToVendor {
  export type Variables = AssignRoleToVendorMutationVariables;
  export type Mutation = AssignRoleToVendorMutation;
  export type AssignRoleToVendor = VendorFragment;
}
