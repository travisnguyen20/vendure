...
import * as VT from './common/generated-vendor-types';
export {VT};
export * from './common/introspection-result-wrapper';
export * from './common/introspection-result';
import * as IVR from './common/introspection-vendor-result';
export {IVR};
...
export * from './data/providers/vendor-data.service';
...
export * from './data/vendor-definitions/vendor-definitions';
